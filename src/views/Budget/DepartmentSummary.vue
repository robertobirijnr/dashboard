        ...
        <div class="col-md-12 col-lg-12">
          <div class="card h-100">
            <div class="card-header">
              <div class="row">
                <div class="col"><button :disabled="!unit_budgets.length" @click="exporrt(period.id, object.id)" class="btn-sm btn btn-primary">EXTRACT</button></div>
  ...
  export default {
    ...
    methods: {
      ...
      details(){
        ...
        const depart_id = this.$route.params.depart_id;
        axios.get(`${config.apiUrl}/budget/dbs/${period_id}/${depart_id}/`, {
          headers: {
