<template>
  ...
  >
    ...
    <div class="nav-wrapper">
      <d-nav class="flex-column text-white">
        <li v-for="(item, navItemIdx) in items" :key="navItemIdx" class="nav-item dropdown text-white">
          <d-link
          ...
          >
            ...
            <span class="text-warning" v-if="item.title">{{ item.title }}</span>
